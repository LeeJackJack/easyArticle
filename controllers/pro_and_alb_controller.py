...
def create_pro_and_alb(user_id, description, name, race, feature, preset, theme_id, album_name, content, image_id):
    # 创建新角色并获取其ID
    ...
    # 新建游戏
    new_game_id=add_game(user_id=user_id, protagonist_id=new_protagonist_id, theme_id=theme_id, content=None,
                         prompt_history=None)
